...
function ProductInfo({ product, handleProductIdChange, leftId, rightId }: any) {
  ...
  return (
    <>
      <div className={`h-fit md:h-[300px] lg:h-[500px] md:flex ${product.ids.length > 1 ? "items-center" : ""} justify-center  lg:row-span-3 lg:col-span-2 my-10 relative`}>
        <div className="w-full md:w-[75%] h-fit overflow-hidden flex justify-center items-center">
          {product?.img ? (
            <img
              src={product.img.url}
              alt={product.name}
              className="object-contain w-fit  p-15"
            />
          ) : (
        ...
        {leftId !== null && (
          <div className="absolute hover:bg-[#259fd332] transition-all -top-10 left-2 group rounded-lg shadow-xl md:hidden">
            <button
              className="h-8 w-20 flex justify-center items-center"
        ...
        {rightId !== null && (
          <div className="absolute hover:bg-[#259fd332] transition-all -top-10 right-2 group rounded-lg shadow-xl md:hidden">
            <button
              className="h-8 w-20 flex justify-center items-center"
