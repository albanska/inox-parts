...
function Form({ id = null, team, close, actionState }) {
  const [changePass, setChangePass] = useState(id ? false : true);
  ...
  return (
    <div className="absolute w-full h-full inset-0 flex justify-center items-center bg-[#202020]/30 z-50">
            ...
            <div className="grow">
              ...
              <div className="flex justify-end flex-col mb-2">
                ...
                <select
                  ...
                  className="focus:outline-0 focus:border-b-[2px] focus:border-b-[#4cc2ff] bg-[#1f1f1f] rounded-md border border-[#282828] h-8 ps-2 text-[12px] tracking-wide transition-all"
                  defaultValue={
                    id ? team.find((m) => m.id === id).status : "main"
                  }
                >
